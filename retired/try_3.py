...
#RECREATING exp_dict
df = pd.DataFrame.from_csv(mypath + 'randomization_2.csv')
...
blocks_final = [low_five, high_five, high_six, low_six, high_seven, low_seven, low_eight, high_eight]
...
probes_position_list = [list_low_five, list_high_five, list_high_six, list_low_six, list_high_seven, list_low_seven, list_low_eight, list_high_eight]

print list_low_five
print list_high_five
#-------------------------------------------------------------------------------------------
...
probes_position_list = [list_low_one, list_high_one, list_high_two, list_low_two, list_high_three, list_low_three, list_low_four, list_high_four]
for i in probes_position_list:
    print i